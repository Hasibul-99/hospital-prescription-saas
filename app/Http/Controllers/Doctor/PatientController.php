...
class PatientController extends Controller
{
    ...
    private function buildPatientQuery(Request $request)
    {
        return Patient::query()
            ...
            // Whitelisted: `sort_by` reaches orderBy() as a column identifier,
            // so an arbitrary value is at best a 500 and at worst sorts by a
            // column the UI never intended to expose.
            ->when(
