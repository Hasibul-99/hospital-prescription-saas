...
- Report PDF export beyond what shipped in Prompt 10 (per-report PDFs) — CSV export exists; broader PDF reporting is deferred (see [prompt-10-report.md](prompt-10-report.md)).
