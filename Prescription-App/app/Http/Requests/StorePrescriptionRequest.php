...
class StorePrescriptionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'medicines.*.additional_doses.*.dose_morning' => 'nullable|numeric|min:0',
            'medicines.*.additional_doses.*.dose_noon' => 'nullable|numeric|min:0',
            'medicines.*.additional_doses.*.dose_afternoon' => 'nullable|numeric|min:0',
            'medicines.*.additional_doses.*.dose_night' => 'nullable|numeric|min:0',
            'medicines.*.additional_doses.*.dose_bedtime' => 'nullable|numeric|min:0',
            'medicines.*.additional_doses.*.duration_value' => 'nullable|integer|min:0',
            'medicines.*.additional_doses.*.duration_unit' => 'nullable|in:days,weeks,months,years,continue,N_A',
            'medicines.*.additional_doses.*.custom_instruction' => 'nullable|string|max:500',
